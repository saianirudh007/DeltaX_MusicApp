<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopsongsDisplay.aspx.cs" Inherits="SpotifyApp1.TopsongsDisplay" %>
...
<head runat="server">
    ...
    <script>
        function show() {
            ...
            xmlhttp.open("GET", "Topsongs.aspx", false);
            xmlhttp.send(null);
        ...
        <div class="navbar navbar-expand-lg bg-success p-2">
            <div class="container-fluid">
                <div class=" d-flex">
                    ...
                    <a href="#" class="nav-link  me-2 text-white"><span class="bi bi-music-note-beamed"> Top 10 Songs</span></a>
